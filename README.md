...
https://blog.phonegap.com/release-of-phonegap-media-stream-d53e5a5bfbf6

https://ionicframework.com/docs/native/social-sharing/

https://www.npmjs.com/package/peerjs-server

npm i -g peer

peerjs --port 9000 --key peerjs --host 0.0.0.0